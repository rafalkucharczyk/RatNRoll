...
class TouchDownQueryCallback : public b2QueryCallback
{
  public:
    ...
    b2Fixture *m_fixture; // we will set this to the first fixture discovered that contains the
                          // touch point, and the program will check this after QueryAABB finishes
