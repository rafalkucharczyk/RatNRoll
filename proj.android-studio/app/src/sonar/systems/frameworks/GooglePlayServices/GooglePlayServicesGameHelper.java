...
/* lukasz */ /* import com.google.android.gms.appstate.AppStateManager; */
...
public class GooglePlayServicesGameHelper implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener 
{
     ...
     */
    public GooglePlayServicesGameHelper(Activity activity, int clientsToUse) 
    {
        mActivity = activity;
                                 ...
                                 Intent intent)
    {
        ...
        else 
        {
            ...
            debugLog("onAR: responseCode="
                    + GooglePlayServicesGameHelperUtils
    ...
    public void onConnectionFailed(ConnectionResult result)
    {
        ...
        debugLog("   - code: "
                + GooglePlayServicesGameHelperUtils.errorCodeToString(mConnectionResult
                .getErrorCode()));
    ...
    void giveUp(SignInFailureReason reason)
    {
        ...
        if (reason.mActivityResultCode == GamesActivityResultCodes.RESULT_APP_MISCONFIGURED)
        {
            ...
            GooglePlayServicesGameHelperUtils.printMisconfiguredDebugInfo(mAppContext);
        }
                                         ...
                                         int errorCode)
    {
        ...
        switch (actResp) 
        {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                errorDialog = makeSimpleDialog(activity, GooglePlayServicesGameHelperUtils.getString(
                        activity, GooglePlayServicesGameHelperUtils.R_APP_MISCONFIGURED));
                break;
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
                errorDialog = makeSimpleDialog(activity, GooglePlayServicesGameHelperUtils.getString(
                        activity, GooglePlayServicesGameHelperUtils.R_SIGN_IN_FAILED));
                break;
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
                errorDialog = makeSimpleDialog(activity, GooglePlayServicesGameHelperUtils.getString(
                        activity, GooglePlayServicesGameHelperUtils.R_LICENSE_FAILED));
                break;
            default:
                ...
                if (errorDialog == null) {
                    ...
                    errorDialog = makeSimpleDialog(
                            activity,
                            GooglePlayServicesGameHelperUtils.getString(activity,
                                    GooglePlayServicesGameHelperUtils.R_UNKNOWN_ERROR)
                                    + " "
                                    + GooglePlayServicesGameHelperUtils.errorCodeToString(errorCode));
                }
        }
    ...
    public static class SignInFailureReason 
    {
        ...
        public String toString() 
        {
            return "SignInFailureReason(serviceErrorCode:"
                    + GooglePlayServicesGameHelperUtils.errorCodeToString(mServiceErrorCode)
